...
$(document).ready(function(){
	 ...
	 $.getJSON('../assignment/application/model/data.json', function(jsonObj) {
		...
		//Get the appletiser main text data
		$('#x3dModelTitle_appletiser').html('<h2>' + jsonObj.pageTextData[5].x3dModelTitle + '<h2>');
		$('#x3dCreationMethod_appletiser').html('<p>' + jsonObj.pageTextData[5].x3dCreationMethod + '<p>');
		$('#title_appletiser').html('<h2>' + jsonObj.pageTextData[5].title + '<h2>');
		$('#subTitle_appletiser').html('<h3>' + jsonObj.pageTextData[5].subTitle + '</h3>');
		$('#description_appletiser').html('<p>' + jsonObj.pageTextData[5].description + '</p>');		
